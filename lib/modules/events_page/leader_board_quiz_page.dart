...
class _LeaderboardQuizPageState extends State<LeaderboardQuizPage> {
  ...
  Future<String> _resolveUserName(String uid) async {
    try {
      ...
      final doc =
          await EventCubit.get(context).fs.collection('users').doc(uid).get();
      final data = doc.data() ?? {};
                    ...
                    : BlocBuilder<EventCubit, EventState>(
                        builder: (context, state) {
                          ...
                          final currentQuestion =
                              eventCubit.leaderboardQuestions[
                          ...
                          final selectedAnswer =
                              eventCubit.leaderboardAnswerForQuestion(
                                  currentQuestion.questionId);

                          final isPreviouslySelected = selectedAnswer != null &&
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            "${eventProgress?.eventScore ?? 0} ${S.of(context).points}",
                                                            textAlign: TextAlign
                                                                .center,
                                                            style:
                                                                const TextStyle(
                                                        ...
                                                        onTap:
                                                            isPreviouslySelected
                                                                ...
                                                                : () async {
                                                                    ...
                                                                    final isGolden =
                                                                        currentQuestion
                                                                            .isGolden(widget.event);

                                                                    final added = isCorrect
                                                                        ? ((isGolden ? widget.event.goldenQuestionPoints : widget.event.normalQuestionPoints) *
                                                                            ((isGolden && watchedRewardedAdForCurrentQuestion)
                                                                                ? widget.event.rewardedAdMultiplier
                                                                                : 1))
                                                                        : 0;

                                                                    await eventCubit
                                                                        .submitLeaderboardAnswer(
                                                                      uid: uid!,
                                                                      event: widget
                                                                          .event,
                                                                      question:
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${S.of(context).correctAnswer}: ${currentQuestion.correctAnswer}",
                                                      style: const TextStyle(
                                                        color: Colors.white,
                                                      ),
                                                    ),
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () async {
                                                ...
                                                final willLoadPrevPage =
                                                    isFirstQuestionInPage &&
                                                        eventCubit
                                                                .leaderboardCurrentPageIndex >
                                                            0;
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () async {
                                                ...
                                                final isLastQuestionInPage = eventCubit
                                                        .leaderboardCurrentQuestionIndex ==
                                                    eventCubit
                                                            .leaderboardQuestions
                                                            .length -
